...
<div class="panel panel-primary">
 ...
 <div class="panel-heading">餐厅信息</div>
  ...
  <button type=button  class="btn btn-success " onclick="location.href =('/restaurant/add')"> <span class="glyphicon glyphicon-plus"></span></button>
...
}).on("loaded.rs.jquery.bootgrid", function()
{
    grid.find(".command-edit").on("click", function(e)
    {
	 ...
	 location.href = "/restaurant/modify/restaurant_id/" + $(this).data("row-id");
...
//	location.href = "/restaurant/remove/restaurant_id" + rows[0];
	$.ajax({
                type: "get",
                url: "/restaurant/remove/restaurant_id/" + rows[0],
                success: function() {
                      //alert('success');
...
function remove1()
{
	...
	//alert(rowIds.join(","));
       $.ajax({
                type: "get",
                url: "/restaurant/remove_selected/restaurant_id/" + rowIds.join(","),
                success: function() {
                      //alert('success');
                  //  editor.insertImage(welEditable, url);
                }

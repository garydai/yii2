        ...
        <table id="grid-selection" class="table table-condensed table-hover table-striped">
                <thead>
                 <tr>
                        ...
                        <th data-column-id="title">游记标题</th>
...
}).on("loaded.rs.jquery.bootgrid", function()
{
    grid.find(".command-edit").on("click", function(e)
    {
         ...
         location.href = "/diary/modify/diary_id/" + $(this).data("row-id");
...
//      location.href = "/room/remove/room_id" + rows[0];
        $.ajax({
                type: "get",
                url: "/diary/remove/modify_id/" + rows[0],
                success: function() {
                      //alert('success');
...
function remove1()
{
       ...
       $.ajax({
                type: "get",
                url: "/diary/remove_selected/diary_id/" + rowIds.join(","),
                success: function() {
                      //alert('success');
                  //  editor.insertImage(welEditable, url);
                }
